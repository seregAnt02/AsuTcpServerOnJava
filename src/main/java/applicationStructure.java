...
4. Удаление ауди-видео файлов с папки Nginx.
    4.1 Реализовать фукционал считывание xml данных файла dash.mpd и удалению файлов
...
// Save model sql
    ...
    class ReceivingDataFromClient {

        /*
            3. Реализовать асинхронный функционал входящего потока на транспортном уровне для добавления, сохранения,
                удаление ауди-видео контента.
               * Создать объект ReceivingDataFromClient(), для получения и распределения данных от клиента,
                 по транспортному протоколу UDP.
               *  Запуск функционала определить в новом потоке.
               *  С входящего потока от клиента видео файлов, принимать и вкладывать в папку Nginx.
               *  С входящего потока данных от клиента ввиде моделей объектов, сохранять в базе данных.
        */
    ...
    class DeleteFilesInDirectoryNginx{
        /*
            4. Удаление ауди-видео файлов с папки Nginx.
                4.1 Реализовать фукционал считывание xml данных файла dash.mpd и удалению файлов
                        на основе значений из метаданных.
                4.2 Функцинал запустить в отдельном потоке.
        */
    }
